...
func TestStaticPropV5_GetAngles(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetDiffuseModulation(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetDisableXBox360(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetFadeMaxDist(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetFadeMinDist(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetFirstLeaf(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetFlags(t *testing.T) {
	sut := getStaticPropV5()
	if sut.GetFlags() != 85 {
...
func TestStaticPropV5_GetForcedFadeScale(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetLeafCount(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetLightingOrigin(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetMaxCPULevel(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetMaxDXLevel(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetMaxGPULevel(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetMinCPULevel(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetMinDXLevel(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetMinGPULevel(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetOrigin(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetPropType(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetSkin(t *testing.T) {
	sut := getStaticPropV5()
	if sut.GetSkin() != 2 {
...
func TestStaticPropV5_GetSolid(t *testing.T) {
	sut := getStaticPropV5()
	if sut.GetSolid() != 1 {
...
func TestStaticPropV5_GetUniformScale(t *testing.T) {
	sut := getStaticPropV5()
...
func TestStaticPropV5_GetUnknown(t *testing.T) {
	sut := getStaticPropV5()
	if sut.GetUnknown() != 0 {
		t.Error("unexpected value for unknown property")
	}
...
func getStaticPropV5() *StaticPropV5 {
	return &StaticPropV5{
