...
func TestVertNormalIndice_GetData(t *testing.T) {
	sut := VertNormalIndice{}
...
func TestVertNormalIndice_Marshall(t *testing.T) {
	sut := VertNormalIndice{}
	data := []uint16{0, 1, 2, 5, 43, 156, 146, 3, 3, 6}
	var buf bytes.Buffer
	err := binary.Write(&buf, binary.LittleEndian, data)
...
func TestVertNormalIndice_Unmarshall(t *testing.T) {
	sut := VertNormalIndice{}
	data := []uint16{0, 1, 2, 5, 43, 156, 146, 3, 3, 6}
	var buf bytes.Buffer
	err := binary.Write(&buf, binary.LittleEndian, data)
